    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-1">
                <div class="flex p-2">
                    <a class="px-4 py-2 rounded text-blue-400 underline decoration-1" href="{{route('roles.index')}}"> < Back to roles</a>
                </div>
                        ...
                        <form method="POST" action="{{route('roles.store')}}">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    ...
                                    @error('name')
                                    <span class="text-sm text-red-700">{{$errors->first('name')}}</span>
                                    @enderror
                                </div>
                            </div>
